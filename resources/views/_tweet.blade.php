<div class="flex p-4 {{ $loop->last ? '' : 'border-b border-b-gray-400 mb-2' }}">
        ...
        <div class="flex">
            <form action="/tweets/{{ $tweet->id }}/like" method="POST">
                ...
                <div class="flex items-center mr-4 {{ $tweet->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }}">
                    ...
                    <button type="submit">
                        <svg viewBox="0 0 20 20" class="w-3 mr-1" style="transform: scale(-1, 1);">
                    ...
                    <p class="text-xs">{{ $tweet->likes ?: 0 }}</p>
